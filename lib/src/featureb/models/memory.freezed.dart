...
mixin _$Memory {
  ...
  String get linkvid => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      linkvid: null == linkvid
          ? _value.linkvid
          : linkvid // ignore: cast_nullable_to_non_nullable
              as String,
      price: null == price
          ? _value.price
...
class _$_Memory implements _Memory {
  ...
  @override
  String toString() {
    return 'Memory(id: $id, title: $title, description: $description, linkvid: $linkvid, price: $price, imageId: $imageId, createdAt: $createdAt, profileId: $profileId, username: $username)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.linkvid, linkvid) || other.linkvid == linkvid) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, description, linkvid,
      price, imageId, createdAt, profileId, username);
